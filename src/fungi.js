...
function PageHeader(props) {
  return (
    <div className="page-header">
      ...
      <div className="fb-share-button pull-right" data-href="https://fungius.com/" data-layout="button_count" data-size="small"><a target="_blank" rel="noreferrer noopener" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffungius.com%2F&amp;src=sdkpreparse" className="fb-xfbml-parse-ignore">Share</a></div>
